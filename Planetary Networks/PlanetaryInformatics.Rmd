...
numPlanet_Com1 <- nrow(subset_Com1)
numPlanet_Com2 <- nrow(subset_Com2)
numPlanet_Com3 <- nrow(subset_Com3)
numPlanet_Com4 <- nrow(subset_Com4)
numPlanet_Com5 <- nrow(subset_Com5)
