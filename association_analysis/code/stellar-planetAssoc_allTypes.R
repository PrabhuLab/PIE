#Combined Planet Type and Stellar Type Association
...
write(association.rules, "/Users/vgatne/Documents/PIE/Rules/stellar-planetAssoc_allTypes-rules.csv", row.names = FALSE, sep = ",")
