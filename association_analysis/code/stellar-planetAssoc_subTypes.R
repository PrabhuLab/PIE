#Combined Planet Sub-Type and Stellar Type Association
...
write(association.rules, "/Users/vgatne/Documents/PIE/Rules/stellar-planetAssoc_subTypes-rules.csv", row.names = FALSE, sep = ",")
