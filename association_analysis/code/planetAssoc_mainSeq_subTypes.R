#Planet Sub-Type Association with Main Sequence Stars
...
write(association.rules, "/Users/vgatne/Documents/PIE/Rules/planetAssoc_mainSeq_subTypes-rules.csv", row.names = FALSE, sep = ",")
