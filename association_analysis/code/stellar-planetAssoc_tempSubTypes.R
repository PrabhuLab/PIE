#Combined Temperature based Planet Sub-Type and Stellar Type Association
...
write(association.rules, "/Users/vgatne/Documents/PIE/Rules/stellar-planetAssoc_tempSubTypes-rules.csv", row.names = FALSE, sep = ",")
